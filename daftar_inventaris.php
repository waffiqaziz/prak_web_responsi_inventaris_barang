        ...
        <table cellpadding="10" cellspacing="0" border="1" class="table text-center table-striped">
          ...
          <tbody>
            <?php $harga;$jumlah;$total;$totalinventaris = 0;  
              function rupiah($harga){ // merubah menjadi format rupiah
            ...
            <?php foreach ($dt as $data) : ?>
              <tr>
                <?php
                  $harga = $data -> harga;
                  $jumlah = $data -> jumlah;
                  $total = $harga*$jumlah; // menghitung total harga per baris
                  $newDate = date("d-m-Y", strtotime($data -> tgl_datang)); // ganti menjadi day-month-year
                ?>
                ...
                <?php $totalinventaris += $total ?> <!-- menghitung total inventaris -->
                <!-- OPSI HAPUS -->
